Feature: Execute loyalty level calculation cronjob
  ...
  Scenario: [1]: Basic happy path test from challenge explanation
    ...
    When the robot with UUID "7dd63cbe-d3c8-4ae0-b4b6-0afc87b91a69" does move sequence "LMLMLMLMM"
    ...
    When the robot with UUID "c46b32d0-2386-4ad6-b7ed-4d5215331622" does move sequence "MMRMMRMRRM"
